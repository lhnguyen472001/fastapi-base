...
from apps.blog.repositories import PostCommentRepository, PostVersionRepository
...
# ``posts.comment_count``.
#
# Shape mirrors the post-version sweeper above: every uvicorn worker spawns
# the same forever loop, all workers race for a single Redis leader lock
