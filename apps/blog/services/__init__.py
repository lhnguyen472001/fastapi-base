...
* :mod:`._posts` — :class:`PostService` (orchestrator; delegates autosave
  to :class:`PostAutosaveService` after Phase B.5)
* :mod:`._autosave_service` — :class:`PostAutosaveService`
