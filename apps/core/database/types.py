...
type WhereClauseT = ColumnExpressionArgument[bool]
type OrderingPair = tuple[str | InstrumentedAttribute[Any], bool]
type ExecutableOptions = Sequence[ExecutableOption]
